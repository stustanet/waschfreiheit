...
int se_init()
{
	...
	se_params.input_filter.mid_value_adjustment_speed = 1000;

	se_params.state_filter.reject_consec_count = 15;
	se_params.state_filter.reject_threshold = 13 * 8;

	se_params.state_filter.window_sizes[0] = 200;
	se_params.state_filter.window_sizes[1] = 200;
	se_params.state_filter.window_sizes[2] = 200;
	se_params.state_filter.window_sizes[3] = 200;

	se_params.state_filter.transition_matrix[0 + 0 * (SE_STATECOUNT - 1)] = 0;
	se_params.state_filter.transition_matrix[1 + 0 * (SE_STATECOUNT - 1)] = 100;
	se_params.state_filter.transition_matrix[2 + 0 * (SE_STATECOUNT - 1)] = 0;

	se_params.state_filter.transition_matrix[0 + 1 * (SE_STATECOUNT - 1)] = 0;
	se_params.state_filter.transition_matrix[1 + 1 * (SE_STATECOUNT - 1)] = 0;
	se_params.state_filter.transition_matrix[2 + 1 * (SE_STATECOUNT - 1)] = 0;

	se_params.state_filter.transition_matrix[0 + 2 * (SE_STATECOUNT - 1)] = -50;
	se_params.state_filter.transition_matrix[1 + 2 * (SE_STATECOUNT - 1)] = 0;
	se_params.state_filter.transition_matrix[2 + 2 * (SE_STATECOUNT - 1)] = 0;

	se_params.state_filter.transition_matrix[0 + 3 * (SE_STATECOUNT - 1)] = 0;
	se_params.state_filter.transition_matrix[1 + 3 * (SE_STATECOUNT - 1)] = 0;
