/*
 * Si4463.h
 * Driver for Si4463 radio chip (eg. HoprRF's RFM26) based on the libopencm3 HAL
 *
 * This driver offers some basic functions to send and transmit packets with a Si4463 transceiver
 * using the built-in packet handler of the Si4463
...
/*
 * Initializes the driver and the RF module.
 * This also checks, if the module responds as expected
 */
uint8_t RFM_driver_init(void);

/*
 * Completely re-initializes the RF module
 */
 ...
 *
 * NOTE:
 * The RFM will always be in the RX state unless a transmission is currently ongoing,
...
/*
 * Sends a raw command to the RF module and returns the result
