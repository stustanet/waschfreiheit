...
""")
    ...
    def send_command(self, line, r, writer, direct=False):
        ...
        if len(parts) < 2:
            ...
            # We will still execute the command without node argument.
            # This way the user can see the help text generated by the master node
            self.master.inject_command(parts[0])
            return
